                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                      <b>Hola {{$datos->nombre}}.</b><br>Se ha solicitado la recuperaci&oacute;n de contraseña.<br> tu contraseña es '<b>{{$datos->pass}}</b>'.
                                    <br>Por razones de seguridad cerraremos la sesion de tu cuenta.<br>                         
                                    <br>Si deseas cambiar tu contraseña, puedes hacerlo en el siguiente enlace :<br>
                                    PIN : <b>{{$datos->pin}}</b>
                                  </td>
                                </tr>
                                <tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="width:200px;background:#008000;">
                                            <div>
                                              <a href="{{$datos->enlace}}" style="background-color:#019bd9;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Cambiar Contraseña</a>
                                            </div>
                                          </td>
                                ...
                                <tr>
                                  <td style="padding-top:20px;background-color:#ffffff;"> <i>si no enviaste esta solicitud, haz caso omiso a este correo.</i></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
